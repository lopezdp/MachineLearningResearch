...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k+kn}{import} \PY{n+nn}{numpy}
        ...
        \PY{n}{data}\PY{o}{.}\PY{n}{columns} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number of O\PYZhy{}rings at risk on a given flight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                        \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number experiencing thermal distress}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                        \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Launch temperature (degrees F)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                        \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Leak\PYZhy{}check pressure (psi)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                        \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Temporal order of flight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{data}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number of O\PYZhy{}rings at risk on a given flight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
                   \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Temporal order of flight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{axis} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{,} \PY{n}{inplace} \PY{o}{=} \PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
         ...
         \PY{n}{sb}\PY{o}{.}\PY{n}{distplot}\PY{p}{(}\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Launch temperature (degrees F)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{[}\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number experiencing thermal distress}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} 
                     \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{No Thermal Distress}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{n}{sb}\PY{o}{.}\PY{n}{distplot}\PY{p}{(}\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Launch temperature (degrees F)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{[}\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number experiencing thermal distress}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{!=} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} 
                     \PY{n}{label} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Thermal Distress Present}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
